<div class="mx-auto w-screen px-3">
      ...
      <div class="mb-8">
        <div class="relative h-full rounded-xl bg-white p-5 shadow-lg">
          <img
            ...
            width="335"
            height="210"
            src="{{asset('/public/IMG/Evento.png')}}"
            alt=""
          />
          <div class="pt-6">
            <div class="absolute right-10 top-10 z-[1] mb-6">
              <a class="inline-block h-8 rounded-3xl border border-orange-500 bg-[#FAEBE1] px-3.5 py-2 text-sm leading-none text-primary transition-all hover:bg-orange-500 hover:text-white" 
              href="#">Development</a>
            </div>
            <h3 class="h4 mb-4 text-[19px]">
            ...
            <div class="border-t border-border pt-6 pb-0 mt-6 flex space-x-4">
